        ...
        <DialogTrigger className="flex justify-start">
          <div>
            ...
            {signature && isDataUrl(signature) ? (
              <img
                className="border border-black rounded-md hover:border-blue-400 bg-white"
                src={signature}
                width={300}
                alt=""
              />
              ...
              <div
                ...
                className="flex flex-col justify-center items-center h-[155px] rounded-md bg-gray-100 dark:bg-slate-800 border border-black dark:border-white hover:border-blue-400"
              >
                <FileSignature />
