			...
			<div>
				<div>
					...
					<address className="mt-4 not-italic text-gray-800">
						...
						<h1 className="text-center text-3xl font-bold mb-4">Payment Voucher</h1>
						...
						<div className="grid grid-cols-2 gap-x-8 gap-y-4 mb-4">
							<div className="space-y-2 text-left">
								...
								<div>
									<span className="font-semibold">Address:</span> {receiver.address}
								</div>
							</div>
					...
					<div className="sm:text-right space-y-2">
						<div className="grid grid-cols-1 sm:grid-cols-1 gap-3 sm:gap-2">
							<dl className="grid sm:grid-cols-5 gap-x-3">
								{/* Discount */}
								{details.discountDetails?.amount && details.discountDetails.amount > 0 && (
									<div>
								...
								{/* Tax */}
								{details.taxDetails?.amount && details.taxDetails.amount > 0 && (
									<div>
								...
								{/* Shipping */}
								{details.shippingDetails?.cost && details.shippingDetails.cost > 0 && (
									<div>
								...
								{details.totalAmountInWords && (
									<div className="sm:col-span-5 text-right">
										<dt className="font-semibold text-gray-800 inline">Total in words:</dt>
